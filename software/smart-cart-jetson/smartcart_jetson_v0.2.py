            ...
            while True:
                ...
                for contour in contours:
                    ...
                    if y > prev_frame.shape[0] / 2:
                        ...
                        model = YOLO('productmodel_231212nano.pt')  # pretrained YOLOv8n model
                        
                        # Run batched inference on a list of images
                        model.predict(source='temp.jpg', save_txt=True, project='Top to Bottom', conf=0.5, iou=0.5)  # return a list of Results objects
                        # Exit by pressing 'Q'
                        ...
                        # Run batched inference on a list of images
                        model.predict(source='temp.jpg', save_txt=True, project='Bottom to Top', conf=0.5, iou=0.5)# return a list of Results objects
                        # Exit by pressing 'Q'
                        if cv2.waitKey(1) & 0xFF == ord('q'):
                            break
